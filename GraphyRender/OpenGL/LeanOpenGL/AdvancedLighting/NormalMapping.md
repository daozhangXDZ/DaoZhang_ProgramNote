...
![img](https://learnopengl-cn.github.io/img/05/04/normal_mapping_flat.png)
...
![img](https://learnopengl-cn.github.io/img/05/04/normal_mapping_correct.png)
...
[*E*1*x**E*2*x**E*1*y**E*2*y**E*1*z**E*2*z*]=[Δ*U*1Δ*U*2Δ*V*1Δ*V*2][*T**x**B**x**T**y**B**y**T**z**B**z*]



 

尝试会意一下矩阵乘法，它们确实是同一种等式。把等式写成矩阵形式的好处是，解*T*
...
[Δ*U*1Δ*U*2Δ*V*1Δ*V*2]−1[*E*1*x**E*2*x**E*1*y**E*2*y**E*1*z**E*2*z*]=[*T**x**B**x**T**y**B**y**T**z**B**z*]
...
了。这需要我们计算出delta纹理坐标矩阵的逆矩阵。我不打算讲解计算逆矩阵的细节，但大致是把它变化为，1除以矩阵的行列式，再乘以它的伴随矩阵(Adjugate Matrix)。

 

[*T**x**B**x**T**y**B**y**T**z**B**z*]=1Δ*U*1Δ*V*2−Δ*U*2Δ*V*1[Δ*V*2−Δ*U*2−Δ*V*1Δ*U*1][*E*1*x**E*2*x**E*1*y**E*2*y**E*1*z**E*2*z*]



 

有了最后这个等式，我们就可以用公式、三角形的两条边以及纹理坐标计算出切线向量*T*
...
![img](https://learnopengl-cn.github.io/img/05/04/normal_mapping_tbn_shown.png)
...
![img](https://learnopengl-cn.github.io/img/05/04/normal_mapping_correct_tangent.png)
...
![img](https://learnopengl-cn.github.io/img/05/04/normal_mapping_complex_compare.png)
...
![img](https://learnopengl-cn.github.io/img/05/04/normal_mapping_comparison.png)
