...
![img](Stencil testing.assets/stencil_buffer.png)
...
![img](Stencil testing.assets/stencil_object_outlining.png)
...
在[深度测试](https://learnopengl-cn.github.io/04%20Advanced%20OpenGL/01 Depth testing/)小节的场景中，这个轮廓算法的结果看起来会像是这样的：

![img](Stencil testing.assets/stencil_scene_outlined.png)
