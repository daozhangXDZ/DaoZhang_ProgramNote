...
在[上一节](https://learnopengl-cn.github.io/02%20Lighting/03 Materials/)中，我们讨论了让每个物体都拥有自己独特的材质从而对光照做出不同的反应的方法。这样子能够很容易在一个光照的场景中给每个物体一个独特的外观，但是这仍不能对一个物体的视觉输出提供足够多的灵活性。
...
![img](Lighting_maps.assets/container2.png)
...
![img](Lighting_maps.assets/materials_diffuse_map.png)
...
![img](Lighting_maps.assets/container2_specular.png)
...
![img](Lighting_maps.assets/materials_specular_map.png)
