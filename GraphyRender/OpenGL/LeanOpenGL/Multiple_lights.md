...
首先，我们需要定义一个定向光源最少所需要的变量。我们可以将这些变量储存在一个叫做DirLight的结构体中，并将它定义为一个uniform。需要的变量在[上一节](https://learnopengl-cn.github.io/02%20Lighting/05 Light casters/)中都介绍过：
...
![img](Multiple_lights.assets/multiple_lights_combined.png)
...
![img](Multiple_lights.assets/multiple_lights_atmospheres.png)
