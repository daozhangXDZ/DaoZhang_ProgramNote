...
![img](Light_Colors.assets/light_reflection.png)
...
我们现在已经对颜色有一定的了解了，并且已经创建了一个简单的场景供我们之后绘制动感的光照，我们可以进入[下一节](https://learnopengl-cn.github.io/02%20Lighting/02 Basic Lighting/)进行学习，真正的魔法即将开始！